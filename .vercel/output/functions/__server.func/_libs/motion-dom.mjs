...
export {
  ...
  mixNumber$1 as E,
  Feature as F,
  optimizedAppearDataAttribute as G,
  ...
  calcLength as g,
  cancelFrame as h,
  convertBoundingBoxToBox as i,
  convertBoxToBoundingBox as j,
  createAnimationState as k,
  createBox as l,
  eachAxis as m,
  frame as n,
  frameData as o,
  getFeatureDefinitions as p,
  globalProjectionState as q,
  hover as r,
  isAnimationControls as s,
  isControllingVariants as t,
  isElementTextInput as u,
  isForcedMotionValue as v,
  isHTMLElement as w,
  isMotionValue as x,
  isPrimaryPointer as y,
  isSVGTag as z
};
